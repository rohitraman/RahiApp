...
public class GetRouteActivity extends AppCompatActivity {
    ...
    public static List<String> arrival = new ArrayList<>();
    public static List<String> depart = new ArrayList<>();
    public static List<String> distance_from_source = new ArrayList<>();
    public static List<String> platform = new ArrayList<>();
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    latitudes.add(Double.parseDouble(object2.getString("lat")));
                                    longitudes.add(Double.parseDouble(object2.getString("lng")));
//                                    map.put(object2.getString("code"),object2.getString("name"));
                                    codes.add(object2.getString("code"));
                                    names.add(object2.getString("name"));
                                    arrival.add(object2.getString("arrival"));
                                    depart.add(object2.getString("depart"));
                                    day.add(object2.getString("day"));
                                    distance_from_source.add(object2.getString("distance_from_source"));
                                    platform.add(object2.getString("platform"));
                                    Log.i("hELLO", object2.toString());
                                }

                                startActivity(new Intent(GetRouteActivity.this, TabActivity.class));
